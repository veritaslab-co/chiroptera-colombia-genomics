...
Colombia harbors 222 bat species — approximately 15% of global Chiroptera richness. Despite this exceptional diversity, only 25% of Colombian bat species have any genomic representation in public databases. This repository contains all scripts used to quantify this gap, characterize available sequences by marker and taxonomy, and reconstruct maximum likelihood phylogenies from publicly available data.
